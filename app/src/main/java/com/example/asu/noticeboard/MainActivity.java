...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NoticeText2 = new ParseObject("TestObject");

        ParseQuery<ParseObject> query = ParseQuery.getQuery("TestObject");
        query.getInBackground("pKjvOUKvo3", new GetCallback<ParseObject>() {
            public void done(ParseObject objectt, ParseException e) {
                if (e == null) {
                    // object will be your game score
                    txtt = objectt.getString("TheNoticeRead");
                    txt1.setText(txtt);
    ...
    private void addDrawerItems() {
        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (pos == 1){
                    Toast.makeText(MainActivity.this, "For Admin Use Only", Toast.LENGTH_SHORT).show();
